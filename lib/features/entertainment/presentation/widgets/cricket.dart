...
var videoURL="https://www.googleapis.com/youtube/v3/search?q=home%20training%20for%20cricket&part=snippet&type=video&maxResults=50&key=";
@override
void initState()
{
  super.initState();
        ...
        AppBackground(),
          ...
          width: MediaQuery.of(context).size.width - 10,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      new Text("Cricket Training at home",style: 
                      TextStyle(
                        color: Colors.black,
                        fontFamily: 'google',
                        fontSize: 16.0,
