...
var videoURL="https://www.googleapis.com/youtube/v3/search?q=home%20training%20for%20football&part=snippet&type=video&maxResults=50&key=";
  @override
  void initState() {
    super.initState();
      ...
      new ListView(padding: const EdgeInsets.all(0.0), children: <Widget>[
        ...
        new Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              new Text("Football Training at home",
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'google',
                      fontSize: 16.0,
