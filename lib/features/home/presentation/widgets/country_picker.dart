...
class CountryPick extends StatelessWidget {
  ...
  Widget build(BuildContext context) {     
    ...
    var codes = json.encode(countryCodes.toString());
    return Container(
      child: CountryCodePicker(
        ...
        onChanged: (CountryCode code) {
          var reversed=countryCodes.map((k, v) => MapEntry(v, k));
          print(countryCodes);
          print(code.name);
          print(code.code);
          print(code.dialCode);
          print(code.flagUri);
          var country = new Country(code: code.code, name: reversed[code.code]);
          var countryProvider=Provider.of<CountryProvider>(context,listen: false);
          countryProvider.setCountry(country);
          //_savePreference(code.code,reversed[code.code]);
